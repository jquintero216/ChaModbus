...
int UnitID=1,v1=0,v2=0,v3=0,v4=0,v5=0,v6=0,v7=0,seleccion_menu=0,eb=0,er=0;
...
int main(int argc, char **argv)
{
    ...
    do{
		...
		switch(seleccion_menu){
			...
			case 6:{ //FC-06 - Escribir registro holding (4X)
			...
			case 8:{ //FC-10 - Escribir multiples registros holding (4X)
